...
export function MobileNav() {
  ...
  return (
    <>
      <header className="fixed left-0 right-0 top-0 z-50 flex items-center justify-between border-b border-chalk bg-field-paper/90 py-4 pl-gutter pr-[8.5rem] backdrop-blur-md lg:hidden">
      ...
      <nav
        className={`fixed left-0 top-0 z-[70] flex h-full w-[min(85vw,320px)] flex-col justify-between border-r border-chalk bg-field-paper px-8 py-10 transition-transform duration-300 lg:hidden ${
